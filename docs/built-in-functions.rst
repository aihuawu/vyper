...
.. py:function:: blockhash(block_num: uint256) -> bytes32
    ...
    .. note::
        ...
        The EVM only provides access to the most 256 blocks. This function returns 0 if the block number is greater than or equal to the current block number or more than 256 blocks behind the current block.
